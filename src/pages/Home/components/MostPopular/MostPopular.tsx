  ...
  return (
    <section className={style.mostPopular}>
      <div className={style.mostPopular__text}>
        ...
        <p>
          Choose the right car for you here in the fewest possible steps,We
          offer a large number of cars, different classes and for any of your
          needs,business,romantic and family trip
        </p>
      </div>
